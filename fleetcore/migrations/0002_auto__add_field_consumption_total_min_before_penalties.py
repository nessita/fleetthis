...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consumption.total_min_before_penalties'
        db.add_column('fleetcore_consumption', 'total_min_before_penalties',
                      self.gf('fleetcore.fields.MinuteField')(default='0', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consumption.total_min_before_penalties'
        db.delete_column('fleetcore_consumption', 'total_min_before_penalties')
    ...
    models = {
        ...
        'fleetcore.consumption': {
            ...
            'total_min_before_penalties': ('fleetcore.fields.MinuteField', [], {'default': "'0'", 'max_digits': '10', 'decimal_places': '2'})
        },
        'fleetcore.datapack': {
