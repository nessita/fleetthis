...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consumption.total_min'
        db.delete_column('fleetcore_consumption', 'total_min')
    ...
    def backwards(self, orm):
        # Adding field 'Consumption.total_min'
        db.add_column('fleetcore_consumption', 'total_min',
