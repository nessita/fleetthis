...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consumption.extra'
        db.add_column('fleetcore_consumption', 'extra',
                      self.gf('fleetcore.fields.MoneyField')(default='0', max_digits=10, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consumption.extra'
        db.delete_column('fleetcore_consumption', 'extra')
    ...
    models = {
        ...
        'fleetcore.phone': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 8, 0, 0)'}),
