...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Phone', fields ['user']
        db.delete_unique('fleetcore_phone', ['user_id'])


        # Changing field 'Phone.user'
        db.alter_column('fleetcore_phone', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Phone.user'
        db.alter_column('fleetcore_phone', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Phone', fields ['user']
        db.create_unique('fleetcore_phone', ['user_id'])
    ...
    models = {
        ...
        'fleetcore.phone': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 0, 0)'}),
